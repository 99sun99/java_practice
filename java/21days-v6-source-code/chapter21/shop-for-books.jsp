...
String bnLink = "http://search.barnesandnoble.com/booksearch/"
...
<form action="shop-for-books.jsp" method="POST">
<p><input type="radio" value="Amazon"
<%= (store.equals("Amazon") ? " checked" : "") %>
name="store"> Amazon.Com
<p><input type="radio" value="BN"
<%= (store.equals("BN") ? " checked" : "") %>
